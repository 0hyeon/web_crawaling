...
const MeterialCreate = () => {
  ...
  const [
    ...
    const submitFn = async (
      ...
      console.log(isData?.filter((el)=>el.id === Number(router.query.chennelId))[0]['channel'])
  return (
    <Layout>
      ...
      <Select 
       ...
       <Select 
          ...
          value={state.몰}
          onChange={(value: string | null) => dispatch({ type: 'update', name: '몰', value })}
          size="sm"
          withAsterisk
          w={400}
          sx={{
        ...
        <Select 
          ...
          value={state.구분1}
          onChange={(value: string | null) => dispatch({ type: 'update', name: '구분1', value })}
          size="sm"
          withAsterisk
          w={400}
          sx={{
        ...
        <Select 
          ...
          value={state.구분2}
          onChange={(value: string | null) => dispatch({ type: 'update', name: '구분2', value })}
          size="sm"
          withAsterisk
          w={400}
          sx={{
