    ...
    <>
      <div id="header_wrap">
        ...
        <div id="about_wrap" className="bg-[#f5f5f5]">
          <div id="about_title" className="pt-[120px]">
            ...
            >
              ...
              <li className="about_pb2 pb-[2rem]">
                <Image
        ...
        <div id="campaign_wrap">
          <div id="campaign_title" className="a-center">
            <Image
              src="https://greenbricks.co.kr/images/campaign_title.png"
              alt="OUR campaigns"
              style={{ listStyle: "none", margin: "0 auto" }}
              width={726}
              height={64}
            />
          </div>
          ...
          <div id="campaign_03_app" className="pt160">
            <ul
              id="campaign"
              className="a-center pt160"
              style={{ listStyle: "none" }}
          ...
          <div id="campaign_08_img">
            <ul
              ...
              style={{ listStyle: "none" }}
            >
              <li className="campaign_name pb53">
                무학소주의 좋은데이
                <br />
                “좋은날이 올거에요, 좋은데이”
                <br />
        ...
        <div id="business_wrap">
          <div id="business_title">
            ...
            >
              ...
              <li className="business_bt2" style={{ textAlign: "left" }}>
          ...
          <div id="business_img">
            <ul id="business_img_c" className="a-center pb300">
              <li>
                <Image
            ...
            <div id="recruit_title">
              ...
              >
                ...
                >
                  ...
                  마음으로 시작했습니다.
                  <br />
                  일하기 즐거운 회사 그린브릭스에서 함께 블록을 쌓아 주실
                  여러분을 기다립니다.
                </li>
                <li className="business_bt3">
