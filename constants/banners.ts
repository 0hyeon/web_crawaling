...
export const SSG_FILTERS = [
  {
    카울리: {
      channels: ["re_caw1", "re_caw2", "re_caue1", "re_caue2"],
    },
    캐시슬라이드: {
      channels: [
        "mid_cashslide_ssg1",
    ...
    몰로코: {
      channels: ["ssg_re_moloco_dco", "emall_re_moloco_dco"],
    },
    피코나: {
      channels: ["mid_pcona_ssg1", "mid_pcona_e1"],
    },
    모비온: {
      channels: ["re_mobionssg1", "re_mobione1"],
    },
    "버즈빌[RE]": {
      channels: ["re_buzz1", "buzz_e1"],
    },
    크리테오: {
      channels: ["re_criteo1", "criteo_re_1"],
    },
    애드픽: {
      channels: [
        "ssg_adpick_cps1",
